# Intance Variables VS Class Variables 
...
class Employee:
    ...
    def showDetails(self):
        print(f"The name of the Employee is {self.name} and the raise amount in {self.numberOfEmployee} sized {self.companyName} is {self.raise_amount}")
