...
# In this example, the MyClass class has a single property, value, which is initialized in the init method. The value method is defined as a getter using the @property decorator, and is used to return the value of the value property.
